...
class ArcView @JvmOverloads constructor(
    ...
    init {
        ...
        val initData = ArcInitData(
            typedArray.getColor(R.styleable.ArcView_arcColor, ContextCompat.getColor(context, R.color.arc)),
            typedArray.getDimension(R.styleable.ArcView_arcStrokeWidth, context.resources.getDimensionPixelSize(R.dimen.arc_stroke_width).toFloat()),
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas.drawArc(rectF, parameter.startAngle, parameter.sweepAngle, parameter.useCenter, paint)
    }
}